...
public abstract class AbstractHero : IHero, IComparable<AbstractHero>
{
    ...
    public ICollection<IItem> Items
    {
        get
        {
            var clazz = typeof(HeroInventory);
            var field = clazz.GetFields(BindingFlags.Instance | BindingFlags.NonPublic).FirstOrDefault(f => f.GetCustomAttribute(typeof(ItemAttribute)) != null);
